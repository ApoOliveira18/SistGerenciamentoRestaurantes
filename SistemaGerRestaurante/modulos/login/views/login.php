...
<div class="loginbox radius3">
  <div class="loginboxinner radius3">
    	<div class="loginheader">
    		<h1 class="bebas" style="text-align:center"><img src="<?php echo base_url(); ?>assets/pdv/img/Sanja.png" style="width: 100px;margin-top: -20px;"></h1>
