        ...
        <div class="body">
            ...
            <div class="col_2" id="lista_produtos">
            	<div class="col_2_row_11">
                    <!--<span id="nome_menu_topo"><?php echo $config->nome_fantasia; ?></span>-->
                    <a href="" class="logo_a"><img src="<?php echo base_url(); ?>assets/pdv/img/Sanja.png" style="width: 70px;margin-top: 0px;"></a>
                ...
                <div class="col_2_row_21">
                	<div id="pedido_fechamento" class="col2_row2_outro">
                        ...
                        <div id="calculo_pagamento">
                            ...
                            <input type="text" name="input_valor_receber"  class="input_3" value="" placeholder="0.00" style="    width: 247px"/>
                        ...
                        <div id="formas_pagamento">
                            ...
                            <div id="forma_cheque" class="formas_pagamento" id_forma="-4">Sodexo/Alelo</div><!-- (-4) -->
